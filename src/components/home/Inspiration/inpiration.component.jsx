    ...
    return(
      <Fragment>
      {
        ourInspiration &&
          ...
          <div className="image-column" style={{boxShadow: '10px 10px 80px #5b5555',backgroundImage: `url(${ourInspiration.imageUrl})`}} />
          <div className="container">
            ...
            <p >{ourInspiration.middleText}</p>
          </div>
              <div className="col-md-6 col-md-offset-6 text-column">
                <h2>{ourInspiration.title}</h2>
                <h3 />
                <p>{ourInspiration.text}</p>
              </div>
            </div>
          </div>
        </div>
